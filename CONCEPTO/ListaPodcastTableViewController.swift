...
class ListaPodcastTableViewController: UITableViewController {
    
    //paso 8 definir direccion
    //let direccion = "http://199.233.252.86/datos/datos.json"
    let direccion = "http://conceptoradial.000webhostapp.com/json/podcasts2.json"
    ...
    let datosJSON = "[ {\"nombre\": \"Podcast1\",\"subnombre\": \"Podcast1-Titulo\",\"URL\":\"http://podcastcdn-16.ivoox.com/audio/6/4/4/1/influenzaestacional-wernickebroca-ivoox13631446.mp3?secure=er6bQJv-_jNawcvIS9l4tw==,1489892439\"},{\"nombre\": \"Podcast2\",\"subnombre\": \"Podcast2-Titulo\",\"URL\":\"http://podcastcdn-16.ivoox.com/audio/6/4/4/1/influenzaestacional-wernickebroca-ivoox13631446.mp3?secure=er6bQJv-_jNawcvIS9l4tw==,1489892439896\"}]"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let siguienteVista = segue.destination as! SeleccionPodcastViewController
